...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2021 at 01:06 AM
...
(40, 'tn_31953844461a6b3040a4a1', 9, '{\"video_0\":\"https:\\/\\/www.youtube.com\\/watch?v=YE7VzlLtp-4\",\"video_1\":\" https:\\/\\/www.youtube.com\\/watch?v=JTOJsU3FSD8\"}', 'This is the IWP VIDEO', 'For IWP', 'https://i.ytimg.com/vi/YE7VzlLtp-4/hqdefault.jpg', 'public', 'published', '2021-11-30 23:25:56');
...
--
ALTER TABLE `tb_videos`
  MODIFY `vid_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
COMMIT;
